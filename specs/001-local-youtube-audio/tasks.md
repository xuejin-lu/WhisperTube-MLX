...
- [X] T023 Fix deterministic CI checkout depth for `git diff --check HEAD^`, push the completed migration and verification commit, then check `.github/workflows/test.yml` CI status
